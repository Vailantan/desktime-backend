...
def accept_image(request):
  if(request.method == "POST"):
    class_image = request.FILES["image"]
    if class_image:
      return HttpResponse("<h1>Received the image</h1>")
    else:
      return HttpResponse("<h1>Image not found</h1>")
    
  return HttpResponse("Lavde GET request bhej")
